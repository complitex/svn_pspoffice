...
CREATE TABLE `registration` (
  ...
  KEY `key_status` (`status`),
  KEY `key_permission_id` (`permission_id`),
  CONSTRAINT `fk_registration__entity_type` FOREIGN KEY (`entity_type_id`) REFERENCES `entity_type` (`id`),
...
CREATE TABLE `owner_relationship` (
  ...
  KEY `key_status` (`status`),
  KEY `key_permission_id` (`permission_id`),
  CONSTRAINT `fk_owner_relationship__entity_type` FOREIGN KEY (`entity_type_id`) REFERENCES `entity_type` (`id`),
