...
public class FamilyAndApartmentInfoBean extends AbstractBean {
    ...
    @Transactional
    public FamilyAndApartmentInfo getInfo(String addressEntity, long addressId, Locale locale) {
        ...
        for (Person person : persons) {
            ...
            member.setBirthDate(personStrategy.getBirthDate(person));
            member.setRegistrationDate(registrationStrategy.getRegistrationDate(person.getRegistration()));
