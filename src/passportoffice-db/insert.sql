...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (1, 1, 1, 2);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (2, 2, 1, 4);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (3, 3, 1, 6);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (4, 4, 1, 11);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (5, 5, 1, 15);
insert into `string_culture`(`id`, `locale`, `value`) values (16, 'ru', 'Корпус'), (16, 'en', 'Building corps.');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (6, 5, 0, 16);
insert into `string_culture`(`id`, `locale`, `value`) values (17, 'ru', 'Строение'), (17, 'en', 'Building structure');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (7, 5, 0, 17);
insert into `string_culture`(`id`, `locale`, `value`) values (18, 'ru', 'Улица'), (18, 'en', 'Street');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (8, 5, 0, 18);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (9, 6, 1, 20);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (10, 7, 1, 22);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (11, 8, 1, 24);
...
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (12, 9, 1, 26);
insert into `string_culture`(`id`, `locale`, `value`) values (27, 'ru', 'Отчество'), (27, 'en', 'Middle name');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (13, 9, 1, 27);
insert into `string_culture`(`id`, `locale`, `value`) values (28, 'ru', 'Фамилия'), (28, 'en', 'Last name');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (14, 9, 1, 28);
insert into `string_culture`(`id`, `locale`, `value`) values (29, 'ru', 'Дата рождения'), (29, 'en', 'Birth date');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (15, 9, 1, 29);
insert into `string_culture`(`id`, `locale`, `value`) values (30, 'ru', 'Пол'), (30, 'en', 'Sex');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (16, 9, 1, 30);
insert into `string_culture`(`id`, `locale`, `value`) values (31, 'ru', 'Номер пасспорта'), (31, 'en', 'Passport number');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (17, 9, 1, 31);
insert into `string_culture`(`id`, `locale`, `value`) values (32, 'ru', 'Серия пасспорта'), (32, 'en', 'Passport serial number');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (18, 9, 1, 32);
insert into `string_culture`(`id`, `locale`, `value`) values (33, 'ru', 'Адрес'), (33, 'en', 'Address');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`) values (19, 9, 1, 33);
