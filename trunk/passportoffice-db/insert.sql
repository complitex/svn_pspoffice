...
insert into `string_culture`(`id`, `locale`, `value`) values (901, 'ru', 'Регистрация'), (901, 'en', 'Registration');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (900, 900, 1, 901, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (902, 'ru', 'Имя'), (902, 'en', 'Name');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (901, 900, 1, 902, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (903, 'ru', 'Отчество'), (903, 'en', 'Middle name');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (902, 900, 1, 903, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (904, 'ru', 'Фамилия'), (904, 'en', 'Last name');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (903, 900, 1, 904, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (905, 'ru', 'Дата рождения'), (905, 'en', 'Birth date');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (904, 900, 1, 905, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (906, 'ru', 'Место рождения'), (906, 'en', 'Place of birth');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (905, 900, 1, 906, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (907, 'ru', 'Пол'), (907, 'en', 'Sex');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (906, 900, 1, 907, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (908, 'ru', 'Паспорт'), (908, 'en', 'Passport');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (907, 900, 1, 908, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (909, 'ru', 'Адрес прибытия'), (909, 'en', 'Arrived from');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (908, 900, 1, 909, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (910, 'ru', 'Адрес убытия'), (910, 'en', 'Going to');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (909, 900, 1, 910, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (911, 'ru', 'Отношение к владельцу'), (911, 'en', 'Relation to owner');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (910, 900, 1, 911, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (912, 'ru', 'Отношение к остальным проживающим'), (912, 'en', 'Relation to other');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (911, 900, 0, 912, 1);
insert into `string_culture`(`id`, `locale`, `value`) values (913, 'ru', 'Документ права на жилпощадь'), (913, 'en', 'Rights on dwelling space');
insert into `entity_attribute_type`(`id`, `entity_id`, `mandatory`, `attribute_type_name_id`, `system`) values (912, 900, 0, 913, 1);

insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (900, 900, 'room');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (901, 900, 'apartment');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (902, 900, 'building');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (903, 901, 'string_culture');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (904, 902, 'string_culture');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (905, 903, 'string_culture');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (906, 904, 'date');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (907, 905, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (908, 906, 'boolean');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (909, 907, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (910, 908, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (911, 909, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (912, 910, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (913, 911, 'string');
insert into `entity_attribute_value_type`(`id`, `attribute_type_id`, `attribute_value_type`) values (914, 912, 'string');
