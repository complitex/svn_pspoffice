...
public abstract class RegistrationStopCouponButton extends ToolbarButton {
    ...
    public RegistrationStopCouponButton(String id) {
        ...
        add(CSSPackageResource.getHeaderContribution(RegistrationStopCouponButton.class,
                RegistrationStopCouponButton.class.getSimpleName() + ".css"));
    }
    ...
    protected Link newLink(String linkId) {
        ...
        link.add(new CssAttributeBehavior("registration_stop_coupon"));
        return link;
    }
}
