...
//import org.complitex.dictionaryfw.strategy.IDao;
//
///**
// *
// * @author Artem
// */
//public abstract class AbstractEntityDao<T extends DomainObject, E extends IEntityExample> implements IDao<T, E> {
//
...
//        T entity = (T) session.selectOne(getNamespace() + "." + FIND_BY_ID_OPERATION, example);
//        if (!(Strings.isEmpty(entity.getParentTable()) && (entity.getParentId() == null))) {
//            DomainObject parent = getParentDao(entity.getParentTable()).
//                    findById(new DomainObjectExample(entity.getParentTable(), new Locale(example.getLocale()), entity.getParentId()));
//            entity.setParent(parent);
//        }
//        return entity;
//    }
//
//    private IDao getParentDao(String parentTable) {
//        try {
//            InitialContext context = new InitialContext();
//            return (IDao) context.lookup("java:module/" + Strings.capitalize(parentTable) + "Dao");
//        } catch (Exception e) {
