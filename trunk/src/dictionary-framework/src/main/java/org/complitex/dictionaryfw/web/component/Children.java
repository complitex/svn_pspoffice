...
//            IModel<List<DomainObject>> childrenEntities, final Class<WebPage> childEditPageClass) {
//        super(id);
//
...
//
//        ListView<DomainObject> children = new ListView<DomainObject>("children", childrenEntities) {
//
//            @Override
